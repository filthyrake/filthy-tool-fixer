...
| **Devstral Small 2** | Dense (24B) | 1-7s | Mistral coding agent, 100% first-attempt accuracy |
...
- **Server**: Intel Xeon Platinum 8160, NVIDIA A30 24GB + NVIDIA A2 16GB, 377GB RAM
- **Fast models** (GPU): Qwen3-Coder 30B (19GB), Qwen3 30B (18GB), Devstral Small 2 (15GB), GLM-4.7-Flash (19GB), GPT-OSS 20B (12GB)
